...
Este proyecto permite crear, visualizar, completar y eliminar tareas desde una interfaz por consola.
Los datos se almacenan localmente en un archivo `tasks.json`, lo que permite mantener la información entre ejecuciones.
...
Importante:
Es necesario configurar correctamente la ruta dentro del archivo `.bat` para que apunte a la ubicación donde se encuentran los archivos del proyecto.
...
El archivo `tasks.json` se utiliza para almacenar las tareas.
Debe contener inicialmente una lista vacía:
